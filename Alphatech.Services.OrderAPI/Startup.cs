...
namespace Alphatech.Services.OrderAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
         ...
         .AddJsonFile($"appsettings.{Environment.GetEnvironmentVariable("ASPNETCORE_ENVIRONMENT")}.json", optional: true, reloadOnChange: true);
           ...
           // services.AddTransient<GetProductOrderService>();
            ...
            {
                options.UseSqlServer(Configuration.GetConnectionString("DefaultConnection"), b => b.MigrationsAssembly("Alphatech.Services.OrderAPI"));
            });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILogger<Startup> logger)
        {
            ...
            //var productConsumer = app.ApplicationServices.GetService<ProductConsumer>();
